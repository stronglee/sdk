...
public class NetworkStatusManager {
    ...
    /**
     * In case of a Disconnect, the connectivity manager may have already established, or may be attempting to
     * establish, connectivity with another network. If so, {@code mOtherNetworkInfo} will be non-null.
     */
    ...
    /**
     * If the most recent connectivity event was a DISCONNECT, return any information supplied in the broadcast about
     * an alternate network that might be available. If this returns a non-null value, then another broadcast should
     * follow shortly indicating whether connection to the other network succeeded.
     *
     * @return NetworkInfo
     */
    ...
    /**
     * Returns true if the most recent event was for an attempt to switch over to a new network following loss of
     * connectivity on another network.
     *
